...
class MenuScreen:
    ...
    def _init_create_room_screen(self):
        ...
        self.room_name_input = TextInput(center_x - 200, 300, 400, 50, ">>> ENTER ROOM NAME <<<")
        self.create_buttons = [
            Button(center_x - 150, 400, 300, 60, "START GAME", self.cyan),
    ...
    def _init_join_room_screen(self):
        ...
        self.room_code_input = TextInput(center_x - 200, 300, 400, 50, ">>> ENTER ROOM CODE <<<")
        self.join_buttons = [
            Button(center_x - 150, 400, 300, 60, "JOIN", self.magenta),
            Button(center_x - 150, 500, 300, 60, "BACK", self.yellow),
        ]
    ...
    def _handle_join_room_events(self, event):
        ...
        if self.room_code_input.handle_event(event):
            if self.room_code_input.text.strip():
    ...
    def _draw_create_room_screen(self):
        ...
        inst_rect = instruction.get_rect(center=(SCREEN_WIDTH // 2, 250))
    ...
    def _draw_join_room_screen(self):
        ...
        instruction = self.small_font.render("ENTER THE ROOM CODE", True, self.yellow)
        inst_rect = instruction.get_rect(center=(SCREEN_WIDTH // 2, 250))
        self.screen.blit(instruction, inst_rect)
